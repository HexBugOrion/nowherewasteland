...
public class NowhereTreeConfig implements FeatureConfig {
    public static final Codec<NowhereTreeConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
        return codecRecorder.group(BlockStateProvider.TYPE_CODEC.fieldOf("trunk_provider").orElse(new SimpleBlockStateProvider(
            Blocks.OAK_LOG.getDefaultState())).forGetter((config) -> {
        ...
        })).apply(codecRecorder, NowhereTreeConfig::new);
    });
    ...
    NowhereTreeConfig(BlockStateProvider trunkProvider, BlockStateProvider leavesProvider, BlockStateProvider groundReplacementProvider, BlockStateProvider diskProvider, int minHeight, int maxHeight, int diskRadius, List<BlockState> whitelist) {
    ...
    public static class Builder {
        ...
        public Builder copy(NowhereTreeConfig config) {
