...
import net.oriondev.nowhere.worldgen.biome.surfaces.SolarValleySB;
...
public class NowhereSurfaceBuilders {
    ...
    public static final SurfaceBuilder<TernarySurfaceConfig> SOLAR_VALLEY = WorldGenRegistryHelper.createSurfaceBuilder("solar_valley", new SolarValleySB(TernarySurfaceConfig.CODEC));
        ...
        public static class Configs{
            public static final TernarySurfaceConfig SOLAR_VALLEY_CF = new TernarySurfaceConfig(BlockRegistry.CRACKED_SOIL.getDefaultState(), BlockRegistry.CRACKED_SOIL.getDefaultState(), BlockRegistry.CRACKED_SOIL.getDefaultState());
