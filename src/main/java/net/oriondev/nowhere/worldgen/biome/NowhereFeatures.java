...
public class NowhereFeatures {
    public static final Feature<DefaultFeatureConfig> DUMMY_TREE = WorldGenRegistryHelper.createFeature("dummy_tree", new DriedTree(DefaultFeatureConfig.CODEC.stable()));
