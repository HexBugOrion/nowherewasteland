...
public class NatronSeaBiome extends NowhereBiome {
    static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = WorldGenRegistryHelper
        .createConfiguredSurfaceBuilder("natron_sea", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new TernarySurfaceConfig(
            BlockRegistry.SALT_BLOCK.getDefaultState(), BlockRegistry.SALT_BLOCK.getDefaultState(), BlockRegistry.SALT_BLOCK.getDefaultState())));
    ...
    static final int WATER_COLOR = 10328443;
    static final int WATER_FOG_COLOR = 3023636;
