...
public class SaltFlatsBiome extends NowhereBiome {
    static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = WorldGenRegistryHelper
        .createConfiguredSurfaceBuilder("salt_flats", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.DEFAULT, new TernarySurfaceConfig(
            BlockRegistry.SALT_BLOCK.getDefaultState(), BlockRegistry.PACKED_DUST.getDefaultState(), BlockRegistry.PACKED_DUST.getDefaultState())));
