package net.vdragondev.nowhere.extras.fluids;
...
public abstract class NowhereFluid extends FlowableFluid {
    /**
    ...
    {
        final BlockEntity
            blockEntity = state.getBlock().hasBlockEntity() ? world.getBlockEntity(pos) : null;
